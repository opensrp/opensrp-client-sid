...
public class ServiceTools {
    ...
    private static boolean isServiceRunning(Class<?> serviceClass) {
        final ActivityManager activityManager = (ActivityManager) VaksinatorApplication.getInstance().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(Context context, Class<?> serviceClass) {
        ...
        if (!isServiceRunning(serviceClass)) {
            ...
            VaksinatorApplication.getInstance().startService(intent);
        }
