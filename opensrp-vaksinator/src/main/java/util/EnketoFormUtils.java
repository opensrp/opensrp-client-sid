...
import static org.smartregister.vaksinator.sync.VaksinClientProcessor.CLIENT_EVENTS;
...
public class EnketoFormUtils {
    ...
    public EnketoFormUtils(Context context) throws Exception {
      ...
      //  mCloudantDataHandler = CloudantDataHandler.getInstance(context.getApplicationContext());
        eventClientRepository = VaksinatorApplication.getInstance().eventClientRepository();
    }
       ...
       /* @Override
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                VaksinClientProcessor.getInstance(context).processClient(eventClientRepository.getEvents(lastSyncDate, BaseRepository.TYPE_Unsynced));
