...
public class SyncStatusBroadcastReceiver extends BroadcastReceiver {
    ...
    private final VaksinatorHomeActivity syncStatusListeners;

    public SyncStatusBroadcastReceiver(VaksinatorHomeActivity vaksinatorHomeActivity) {
        syncStatusListeners = vaksinatorHomeActivity;
    }
