package org.smartregister.vaksinator.facial.activity;
...
public class OpenCameraActivity extends Activity implements PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VaksinatorApplication.getInstance().refreshFaceData();
        initGuiAndAnimation();
        initExtras();
        initializeFlags();
        initListeners();
...
//        settingsActionListener();
    ...
    private void initExtras() {
        ...
        updated = extras.getBoolean("org.smartregister.bidan.facial.activity.OpenCameraActivity.updated");
...
//                }
    ...
    private void savePicture(byte[] data) {
        ...
        if (data != null) {
            intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity", data);
        }
        intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.switchCamera", switchCamera);
        intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.orientation", displayAngle);
        intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.id", entityId);
        intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.identify", identifyPerson);
        intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.origin", str_origin_class);
        intent.putExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.updated", updated);
