...
import org.smartregister.vaksinator.facial.domain.FacialWrapper;
import org.smartregister.vaksinator.facial.domain.ProfileImage;
import org.smartregister.vaksinator.facial.listener.FacialActionListener;
import org.smartregister.vaksinator.facial.repository.ImageRepository;
import org.smartregister.vaksinator.facial.util.BitmapUtil;
...
//        }
    ...
    private void populateClientList(){
        if (imageRepo == null) {
            imageRepo = VaksinatorApplication.getInstance().imageRepository();
        }
        if (repository == null) {
            repository = VaksinatorApplication.getInstance().indonesiaECRepository();
        }
        if (clientList == null){
...
//        toolbar.setNavigationIcon(materialMenu);
    ...
    private void init_extras() {
        ...
        data = getIntent().getByteArrayExtra("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity");
        angle = extras.getInt("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.orientation");
        cameraFront = extras.getBoolean("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.switchCamera");
        ...
        kiclient = extras.getParcelableArray("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.kiclient");
        str_origin_class = extras.getString("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.origin");
        updated = extras.getBoolean("org.smartregister.bidan.facial.activity.PhotoConfirmationActivity.updated");
