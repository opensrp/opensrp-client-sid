...
public class KFPDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fp_detail_activity);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(KFPDetailActivity.this, KFPSmartRegisterActivity.class));
...
//      risk detail
    ...
    public void onBackPressed() {
        finish();
        startActivity(new Intent(this, KFPSmartRegisterActivity.class));
        overridePendingTransition(0, 0);
    }
}