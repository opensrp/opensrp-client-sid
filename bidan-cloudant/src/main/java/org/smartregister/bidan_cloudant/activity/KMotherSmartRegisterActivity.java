...
import org.smartregister.bidan_cloudant.fragment.MotherSmartRegisterFragment;
...
public class KMotherSmartRegisterActivity extends SecuredNativeSmartRegisterActivity implements
    ...
    public static final String TAG = KMotherSmartRegisterActivity.class.getSimpleName();
    ...
    MotherSmartRegisterFragment nf = new MotherSmartRegisterFragment();
    ...
    private DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (which == -1 ){
                ...
                Intent intent= new Intent(KMotherSmartRegisterActivity.this, KMotherSmartRegisterActivity.class);
