...
//        findViewById(R.id.btn_videos).setOnClickListener(onButtonsClickListener);
    ...
    private void initialize() {
        ...
        getSupportActionBar().setIcon(getResources().getDrawable(org.smartregister.bidan_cloudant.R.mipmap.logo));
        getSupportActionBar().setLogo(org.smartregister.bidan_cloudant.R.mipmap.logo);
