...
import org.smartregister.bidan_cloudant.fragment.FPSmartRegisterFragment;
...
public class KFPSmartRegisterActivity extends SecuredNativeSmartRegisterActivity implements
    ...
    public static final String TAG = KFPSmartRegisterActivity.class.getSimpleName();
    ...
    FPSmartRegisterFragment nf = new FPSmartRegisterFragment();
    ...
    private DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (which == -1 ){
                ...
                Intent intent= new Intent(KFPSmartRegisterActivity.this, KFPSmartRegisterActivity.class);
