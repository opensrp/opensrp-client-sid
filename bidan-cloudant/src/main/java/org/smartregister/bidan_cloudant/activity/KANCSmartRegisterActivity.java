...
import org.smartregister.bidan_cloudant.fragment.ANCSmartRegisterFragment;
...
public class KANCSmartRegisterActivity extends SecuredNativeSmartRegisterActivity implements
    ...
    public static final String TAG = KANCSmartRegisterActivity.class.getSimpleName();
    ...
    ANCSmartRegisterFragment nf = new ANCSmartRegisterFragment();
    ...
    private DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (which == -1 ){
                ...
                Intent intent= new Intent(KANCSmartRegisterActivity.this, KANCSmartRegisterActivity.class);
