...
import org.smartregister.bidan_cloudant.fragment.PNCSmartRegisterFragment;
...
public class KPNCSmartRegisterActivity extends SecuredNativeSmartRegisterActivity implements
    ...
    public static final String TAG = KPNCSmartRegisterActivity.class.getSimpleName();
    ...
    PNCSmartRegisterFragment nf = new PNCSmartRegisterFragment();
    ...
    private DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (which == -1 ){
                ...
                Intent intent= new Intent(KPNCSmartRegisterActivity.this, KPNCSmartRegisterActivity.class);
