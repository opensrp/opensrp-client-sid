...
public class PNCSmartClientsProvider implements SmartRegisterCLientsProviderForCursorAdapter {
    ...
    public PNCSmartClientsProvider(Context context, View.OnClickListener onClickListener,
