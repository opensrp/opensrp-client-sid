...
public class FPSmartClientsProvider implements SmartRegisterCLientsProviderForCursorAdapter {
    ...
    public FPSmartClientsProvider(Context context, View.OnClickListener onClickListener,
