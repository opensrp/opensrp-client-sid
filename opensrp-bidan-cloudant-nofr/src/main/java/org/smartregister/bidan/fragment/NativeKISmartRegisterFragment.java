...
import org.smartregister.bidan.activity.DetailIbuActivity;
...
//                    FlurryFacade.logEvent("click_detail_view_on_kohort_ibu_dashboard");
                    DetailIbuActivity.motherClient = (CommonPersonObjectClient) view.getTag();
                    Intent intent = new Intent(getActivity(), DetailIbuActivity.class);
    ...
    private class EditDialogOptionModel implements DialogOptionModel {
        ...
        public void onDialogOptionSelection(DialogOption option, Object tag) {
            ...
            if (option.name().equalsIgnoreCase(getString(R.string.str_register_anc_form))) {
                CommonPersonObjectClient pc = DetailIbuActivity.motherClient;
