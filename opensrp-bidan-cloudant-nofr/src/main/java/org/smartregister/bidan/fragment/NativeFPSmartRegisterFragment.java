...
import org.smartregister.bidan.controller.NativeKBSmartRegisterActivity;
...
public class NativeFPSmartRegisterFragment extends BaseSmartRegisterFragment {
    private static final String TAG = NativeFPSmartRegisterFragment.class.getSimpleName();
...
//        list.setBackgroundColor(Color.RED);
    ...
    public void initializeQueries(String s){
        try {
            ...
            clientAdapter = new SmartRegisterPaginatedCursorAdapter(getActivity(), null, kbScp, new CommonRepository("ec_kartu_ibu",new String []{"ec_kartu_ibu.is_closed", "namalengkap", "umur","namaSuami", "ec_kartu_ibu.isOutOfArea"}));
...
//        FlurryFacade.logEvent("click_start_registration_on_kohort_kb_dashboard");
        ...
        LocationSelectorDialogFragment
                .newInstance((NativeKIFPSmartRegisterActivity) getActivity(), new
