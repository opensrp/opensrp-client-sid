 ...
 */
public class VaksinatorLocationSelectorDialogFragment extends DialogFragment {
    ...
    private VaksinatorLocationSelectorDialogFragment(SecuredNativeSmartRegisterActivity activity,
    ...
    public static VaksinatorLocationSelectorDialogFragment newInstance(
            SecuredNativeSmartRegisterActivity activity,
            DialogOptionModel dialogOptionModel,
            String locationJSONString,String formname) {
        return new VaksinatorLocationSelectorDialogFragment(activity, dialogOptionModel, locationJSONString,formname);
    }
