...
public class UniqueIdBidanRepository extends BaseRepository {
    private static final String TAG = UniqueIdBidanRepository.class.getCanonicalName();
    ...
    public UniqueIdBidanRepository(BidanRepository repository) {
        super(repository);
    }
