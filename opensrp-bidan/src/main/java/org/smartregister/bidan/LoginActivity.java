...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(getResources().getDrawable(org.smartregister.bidan.R.mipmap.logo));
        getActionBar().setBackgroundDrawable(getResources().getDrawable(org.smartregister.bidan.R.color.action_bar_background));
        setLanguage();
