...
import org.smartregister.bidan.BidanEventBusIndex;
...
public class BidanApplication extends DrishtiApplication {
    ...
    private static final String TAG = BidanApplication.class.getCanonicalName();
    ...
    private static String[] getFtsTables() {
        return new String[]{BidanConstants.PATIENT_TABLE_NAME};
    }
    ...
    private void setUpEventHandling() {
        ...
        try {
            ...
            EventBus.builder().addIndex(new BidanEventBusIndex()).installDefaultEventBus();
