package org.smartregister.bidan.tabfragments;
...
import org.smartregister.bidan.activity.ChildDetailTabbedActivity;
...
public class ChildRegistrationDataFragment extends Fragment {
    ...
    public void loadData() {
        if (fragmentView != null) {
            ...
            tvChildsHomeHealthFacility.setText(JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(BidanApplication.getInstance().context(), Utils.getValue(detailsMap, "Home_Facility", false))));
            ...
            tvChildsBirthHealthFacility.setText(JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(BidanApplication.getInstance().context(), childsBirthHealthFacility)));

            if (JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(BidanApplication.getInstance().context(), childsBirthHealthFacility)).equalsIgnoreCase("other")) {
            ...
            tvChildsResidentialArea.setText(JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(BidanApplication.getInstance().context(), childsResidentialArea)));
            if (JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName( BidanApplication.getInstance().context(), childsResidentialArea)).equalsIgnoreCase("other")) {
