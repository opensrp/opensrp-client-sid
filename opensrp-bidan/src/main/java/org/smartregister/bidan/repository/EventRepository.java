...
public class EventRepository {
    ...
    public static List<JSONObject> getANCByBaseEntityId(String baseEntityId){
        ...
        try {
            ...
            cursor = repository.getReadableDatabase().rawQuery("SELECT json, eventDate FROM event WHERE eventType = 'Kunjungan ANC' AND baseEntityId = ? ORDER BY eventDate",new String[]{baseEntityId});
