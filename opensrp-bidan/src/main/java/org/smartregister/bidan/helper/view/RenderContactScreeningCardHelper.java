...
import org.smartregister.bidan.model.Contact;
...
import static org.smartregister.bidan.util.Constants.ScreenStage;
import static util.BidanConstants.CONTACT_TABLE_NAME;
import static util.BidanConstants.KEY;
import static util.BidanConstants.PATIENT_TABLE_NAME;
                            ...
                            public void onClick(View view) {
                                ...
                                if (contact != null) {
                                    if (contact.getStage().equals(ScreenStage.NOT_SCREENED)) {
                                        ...
                                        ((BasePatientDetailActivity) context).startFormActivity(BidanConstants.ENKETO_FORMS.CONTACT_SCREENING, contact.getBaseEntityId(), formOverridesHelper.getContactScreeningFieldOverrides().getJSONString());
                                    } else {
