...
import org.smartregister.bidan.model.BMIRecord;
import org.smartregister.bidan.model.BMIRecordWrapper;
...
public class RenderBMIHeightChartCardHelper extends BaseRenderHelper {
    ...
    private BMIRecordWrapper getData(String baseEntityId) {
        return BidanApplication.getInstance().getBmiRepository().getBMIRecords(baseEntityId);
    }
