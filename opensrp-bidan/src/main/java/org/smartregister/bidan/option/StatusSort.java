...
public class StatusSort implements CursorSortOption {
    ...
    private final Comparator<SmartRegisterClient> commoncomparator = new Comparator<SmartRegisterClient>() {
        ...
        public int compare(SmartRegisterClient oneClient, SmartRegisterClient anotherClient2) {
            ...
            List<Alert> alertlist_for_client1 = BidanApplication.getInstance().context().alertService().findByEntityIdAndAlertNames(oneClient.entityId(), "TT 1", "TT 2", "TT 3", "TT 4", "TT 5", "tt1", "tt2", "tt3", "tt4", "tt5");
            List<Alert> alertlist_for_client2 = BidanApplication.getInstance().context().alertService().findByEntityIdAndAlertNames(anotherClient2.entityId(), "TT 1", "TT 2", "TT 3", "TT 4", "TT 5", "tt1", "tt2", "tt3", "tt4", "tt5");
