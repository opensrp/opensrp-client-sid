...
import org.smartregister.bidan.fragment.KANCSmartRegisterFragment;
import org.smartregister.bidan.fragment.KANCSmartRegisterFragment;
...
public class KANCSmartRegisterActivity extends BaseRegisterActivity {
    private static final String TAG = KANCSmartRegisterActivity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaseFragment = new KANCSmartRegisterFragment();
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof KANCSmartRegisterFragment) {
                LocationPickerView locationPickerView = ((KANCSmartRegisterFragment) mBaseFragment).getLocationPickerView();
    ...
    public void filterSelection() {
        if (currentPage != 0) {
            ...
            if (registerFragment != null && registerFragment instanceof KANCSmartRegisterFragment) {
                ((KANCSmartRegisterFragment) registerFragment).triggerFilterSelection();
            }
        }
    }
