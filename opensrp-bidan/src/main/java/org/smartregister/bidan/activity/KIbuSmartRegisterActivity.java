...
import org.smartregister.bidan.fragment.KIbuSmartRegisterFragment;
...
public class KIbuSmartRegisterActivity extends BaseRegisterActivity {
    private static final String TAG = KIbuSmartRegisterActivity.class.getCanonicalName();
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof KIbuSmartRegisterFragment) {
                LocationPickerView locationPickerView = ((KIbuSmartRegisterFragment) mBaseFragment).getLocationPickerView();
    ...
    public void filterSelection() {
        if (currentPage != 0) {
            ...
            if (registerFragment != null && registerFragment instanceof KIbuSmartRegisterFragment) {
                ((KIbuSmartRegisterFragment) registerFragment).triggerFilterSelection();
            }
        }
    }
