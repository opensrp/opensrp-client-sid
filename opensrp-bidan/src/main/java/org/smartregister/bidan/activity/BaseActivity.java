...
public abstract class BaseActivity extends SecuredActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (BidanApplication.getJsonSpecHelper().getAvailableLanguages().size() < MINIUM_LANG_COUNT) {
    ...
    public Context getOpenSRPContext() {
        return BidanApplication.getInstance().getContext();
    }

    public void showLanguageDialog() {


        final List<String> displayValues = BidanApplication.getJsonSpecHelper().getAvailableLanguages();
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, displayValues.toArray(new String[displayValues.size()])) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                view.setTextColor(BidanApplication.getInstance().getContext().getColorResource(org.smartregister.bidan.R.color.customAppThemeBlue));
        ...
        builder.setSingleChoiceItems(adapter, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Map<String, String> langs = BidanApplication.getJsonSpecHelper().getAvailableLanguagesMap();
