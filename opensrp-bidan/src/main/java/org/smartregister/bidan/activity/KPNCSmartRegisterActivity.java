...
import org.smartregister.bidan.fragment.KPNCSmartRegisterFragment;
...
public class KPNCSmartRegisterActivity extends BaseRegisterActivity {
    private static final String TAG = KPNCSmartRegisterActivity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaseFragment = new KPNCSmartRegisterFragment();
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof KPNCSmartRegisterFragment) {
                LocationPickerView locationPickerView = ((KPNCSmartRegisterFragment) mBaseFragment).getLocationPickerView();
    ...
    public void filterSelection() {
        if (currentPage != 0) {
            ...
            if (registerFragment != null && registerFragment instanceof KPNCSmartRegisterFragment) {
                ((KPNCSmartRegisterFragment) registerFragment).triggerFilterSelection();
            }
        }
    }
