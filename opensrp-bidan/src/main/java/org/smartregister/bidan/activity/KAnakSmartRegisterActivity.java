...
import org.smartregister.bidan.fragment.KAnakSmartRegisterFragment;
...
public class KAnakSmartRegisterActivity extends BaseRegisterActivity {
    private static final String TAG = KAnakSmartRegisterActivity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaseFragment = new KAnakSmartRegisterFragment();
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof KAnakSmartRegisterFragment) {
                LocationPickerView locationPickerView = ((KAnakSmartRegisterFragment) mBaseFragment).getLocationPickerView();
    ...
    public void filterSelection() {
        if (currentPage != 0) {
            ...
            if (registerFragment != null && registerFragment instanceof KAnakSmartRegisterFragment) {
                ((KAnakSmartRegisterFragment) registerFragment).triggerFilterSelection();
            }
        }
    }
