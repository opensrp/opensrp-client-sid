...
////////////////////////////////////////////////////////////////
    ...
    private class SaveTeamLocationsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Utils.writePreference(BidanApplication.getInstance().getApplicationContext(), PREF_TEAM_LOCATIONS, StringUtils.join(locationsCSV, ","));
            return null;
        }
        ...
        private ArrayList<String> locationsCSV() {
            ...
            try {
                locationData = new JSONObject(BidanApplication.getInstance().getContext().anmLocationController().get());
