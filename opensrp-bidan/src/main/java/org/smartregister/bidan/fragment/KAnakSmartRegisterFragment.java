...
import org.smartregister.bidan.activity.KAnakSmartRegisterActivity;
...
public class KAnakSmartRegisterFragment extends BaseSmartRegisterFragment implements SyncStatusBroadcastReceiver.SyncStatusListener {
    ...
    protected void startRegistration() {
        ((KAnakSmartRegisterActivity) getActivity()).startFormActivity("child_enrollment", null, null);
    }
...
//        }
    ...
    private void countOverDue() {
        ...
        ((KAnakSmartRegisterActivity) getActivity()).updateAdvancedSearchFilterCount(count);
    }
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.global_search:
                    ((KAnakSmartRegisterActivity) getActivity()).startAdvancedSearch();
                    break;

                case R.id.scan_qr_code:
                    ((KAnakSmartRegisterActivity) getActivity()).startQrCodeScanner();
                    break;
                default:
                    break;
            }
