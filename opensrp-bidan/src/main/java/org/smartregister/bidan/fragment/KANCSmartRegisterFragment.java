...
public class KANCSmartRegisterFragment extends BaseSmartRegisterFragment implements SyncStatusBroadcastReceiver.SyncStatusListener {
    ...
    protected void startRegistration() {
        ((KANCSmartRegisterActivity) getActivity()).startFormActivity("child_enrollment", null, null);
    }
...
//        }
    ...
    private void countOverDue() {
        ...
        ((KANCSmartRegisterActivity) getActivity()).updateAdvancedSearchFilterCount(count);
    }
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.global_search:
                    ((KANCSmartRegisterActivity) getActivity()).startAdvancedSearch();
                    break;

                case R.id.scan_qr_code:
                    ((KANCSmartRegisterActivity) getActivity()).startQrCodeScanner();
                    break;
                default:
                    break;
            }
