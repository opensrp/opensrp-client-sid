...
import org.smartregister.bidan.kb.AllKBServiceMode;
import org.smartregister.bidan.kb.KBClientsProvider;
import org.smartregister.bidan.kb.KBDetailActivity;
    ...
    public void initializeQueries(String s){
        try {
            ...
            clientAdapter = new SmartRegisterPaginatedCursorAdapter(getActivity(), null, kiscp,
                    new CommonRepository("ec_kartu_ibu",new String []{"ec_kartu_ibu.is_closed", "namalengkap", "umur","namaSuami", "ec_kartu_ibu.isOutOfArea"}));
