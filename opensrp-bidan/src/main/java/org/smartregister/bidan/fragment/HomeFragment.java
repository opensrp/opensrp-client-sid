...
import org.smartregister.bidan.adapter.RegisterArrayAdapter;
import org.smartregister.bidan.application.BidanApplication;
import org.smartregister.bidan.model.Register;
import org.smartregister.bidan.model.RegisterCount;
...
public class HomeFragment extends ListFragment {
    ...
    public void onResume() {
        ...
        try {
            ...
            ViewConfiguration homeViewConfig = jsonString == null ? null : BidanApplication.getJsonSpecHelper().getConfigurableView(jsonString);
    ...
    public static RegisterCount getPatientCountByRegisterType(String registerType) {
        ...
        return BidanApplication.getInstance().getResultDetailsRepository().getRegisterCountByType(registerType);

    }

    private ConfigurableViewsRepository getConfigurableViewsRepository() {
        return BidanApplication.getInstance().getConfigurableViewsRepository();
    }
