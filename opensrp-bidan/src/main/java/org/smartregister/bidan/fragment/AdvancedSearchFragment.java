...
import org.smartregister.bidan.adapter.AdvancedSearchPaginatedCursorAdapter;
import org.smartregister.bidan.domain.RegisterClickables;
import org.smartregister.bidan.provider.AdvancedSearchClientsProvider;
...
public class AdvancedSearchFragment extends BaseSmartRegisterFragment {
    ...
    private void moveToMyCatchmentArea(final List<String> ids) {
        AlertDialog dialog = new AlertDialog.Builder(getActivity(), R.style.PathAlertDialog)
                ...
                .setCancelable(false)
                .setPositiveButton(org.smartregister.bidan.R.string.no_button_label, null)
