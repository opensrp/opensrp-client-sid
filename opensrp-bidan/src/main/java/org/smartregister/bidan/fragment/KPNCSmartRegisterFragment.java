...
public class KPNCSmartRegisterFragment extends BaseSmartRegisterFragment implements SyncStatusBroadcastReceiver.SyncStatusListener {
    ...
    protected void startRegistration() {
        ((KPNCSmartRegisterActivity) getActivity()).startFormActivity("child_enrollment", null, null);
    }
...
//        }
    ...
    private void countOverDue() {
        ...
        ((KPNCSmartRegisterActivity) getActivity()).updateAdvancedSearchFilterCount(count);
    }
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.global_search:
                    ((KPNCSmartRegisterActivity) getActivity()).startAdvancedSearch();
                    break;

                case R.id.scan_qr_code:
                    ((KPNCSmartRegisterActivity) getActivity()).startQrCodeScanner();
                    break;
                default:
                    break;
            }
