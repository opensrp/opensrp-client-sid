...
import static org.smartregister.bidan.util.Constants.CONFIGURATION.LOGIN;
import static org.smartregister.util.Utils.getPreference;
import static util.BidanConstants.LAST_CHECK_TIMESTAMP;
import static util.BidanConstants.LAST_SYNC_TIMESTAMP;
import static util.BidanConstants.LAST_VIEWS_SYNC_TIMESTAMP;
...
public class ECSyncHelper implements PrefsHelper {
    ...
    public static ECSyncHelper getInstance(Context context) {
        if (instance == null) {
            instance = new ECSyncHelper(context, BidanApplication.getInstance().getEventClientRepository());
        }
        return instance;
    }
    ...
    public JSONObject fetchAsJsonObject(String filter, String filterValue) throws Exception {
        try {
            HTTPAgent httpAgent = BidanApplication.getInstance().getContext().getHttpAgent();
            String baseUrl = BidanApplication.getInstance().getContext().
