...
//                builder.setMessage("Process Time : " + proc_time + " s");
    ...
    public DialogOption[] getEditOptions() {
        return new DialogOption[]{
                new OpenFormOption(getString(R.string.str_anak_neonatal), AllConstantsINA.FormNames.BAYI_NEONATAL_PERIOD, formController),
                new OpenFormOption(getString(R.string.str_anak_bayi_visit), AllConstantsINA.FormNames.KOHORT_BAYI_KUNJUNGAN, formController),
                new OpenFormOption(getString(R.string.str_anak_balita_visit), AllConstantsINA.FormNames.BALITA_KUNJUNGAN, formController),
          //      new OpenFormOption(getString(R.string.str_anak_edit), KOHORT_BAYI_EDIT, formController),
                new OpenFormOption(getString(R.string.str_child_immunizations), AllConstantsINA.FormNames.BAYI_IMUNISASI, formController),
                new OpenFormOption(getString(R.string.str_child_close), AllConstantsINA.FormNames.KARTU_IBU_ANAK_CLOSE, formController),
...
//        Log.v("fieldoverride", metaData);
    ...
    private String[] buildFormNameList(){
        ...
        formNames.add(AllConstantsINA.FormNames.BAYI_NEONATAL_PERIOD);
        formNames.add(AllConstantsINA.FormNames.KOHORT_BAYI_KUNJUNGAN);
        formNames.add(AllConstantsINA.FormNames.BALITA_KUNJUNGAN);
        formNames.add(AllConstantsINA.FormNames.KARTU_IBU_ANAK_CLOSE);
        formNames.add(AllConstantsINA.FormNames.BAYI_IMUNISASI);
