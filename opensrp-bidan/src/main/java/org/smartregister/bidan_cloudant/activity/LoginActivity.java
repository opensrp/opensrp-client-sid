...
//        context = Context.getInstance().updateApplicationContext(this.getApplicationContext());
        ...
        getActionBar().setIcon(getResources().getDrawable(org.smartregister.bidan_cloudant.R.mipmap.logo));
        getActionBar().setBackgroundDrawable(getResources().getDrawable(org.smartregister.bidan_cloudant.R.color.action_bar_background));
        setLanguage();
