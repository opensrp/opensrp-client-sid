...
public class Generator {
    ...
    public AllSettingsINA allSettingsINA() {
        BidanApplication.initializeRepositoryForUniqueId();
//        context.initializeRepositoryForUniqueId();
        if(allSettingsINA == null)
            allSettingsINA = new AllSettingsINA(context.allSharedPreferences(), BidanApplication.getSettingsRepositoryforUniqueId());
