...
import org.smartregister.bidan.sync.TbrClientProcessor;
...
import static org.smartregister.bidan.sync.TbrClientProcessor.CLIENT_EVENTS;
import static org.smartregister.bidan.sync.TbrClientProcessor.CONTACT_SCREENING;
import static org.smartregister.bidan.sync.TbrClientProcessor.DIAGNOSIS_EVENT;
import static org.smartregister.bidan.sync.TbrClientProcessor.TREATMENT_INITIATION;
import static org.smartregister.util.Log.logInfo;
import static util.BidanConstants.KEY.ATTRIBUTE_DATEREMOVED;
import static util.BidanConstants.KEY.BASELINE;
import static util.BidanConstants.KEY.DIAGNOSIS_DATE;
import static util.BidanConstants.TBREACH_ID;
...
public class EnketoFormUtils {
    ...
    public EnketoFormUtils(Context context) {
        ...
        eventClientRepository = BidanApplication.getInstance().getEventClientRepository();
    }
