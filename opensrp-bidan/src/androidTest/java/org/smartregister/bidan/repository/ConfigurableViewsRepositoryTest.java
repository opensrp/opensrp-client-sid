...
public class ConfigurableViewsRepositoryTest {
    ...
    private BidanRepositoryShadow repositoryShadow = new BidanRepositoryShadow(BidanApplication.getInstance().getApplicationContext(), BidanApplication.getInstance().getContext());
