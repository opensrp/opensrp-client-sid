...
public class BidanApplicationTestVersion extends BidanApplication implements TestLifecycleApplication {
    @Mock
    ...
    public static final String TAG = BidanApplicationTestVersion.class.getCanonicalName();
