...
public class FormOverridesHelperTest {
    ...
    public void setUp() {
        ...
        patientDetails.put(BidanConstants.KEY.PARTICIPANT_ID, "5345");
        patientDetails.put(BidanConstants.KEY.FIRST_NAME, "William");
        patientDetails.put(BidanConstants.KEY.LAST_NAME, "Tell");
        patientDetails.put(BidanConstants.KEY.PROGRAM_ID, "7730");
        patientDetails.put(BidanConstants.KEY.TREATMENT_INITIATION_DATE, "2017-03-20");
    ...
    public void getFieldOverridesReturnsCorrectInstanceForSetDetails() {
        ...
        patientDetails.put(BidanConstants.KEY.PARTICIPANT_ID, "1099");
        patientDetails.put(BidanConstants.KEY.FIRST_NAME, "Speedy");
        patientDetails.put(BidanConstants.KEY.LAST_NAME, "Gonzalez");
        patientDetails.put(BidanConstants.KEY.PROGRAM_ID, "77555");
    ...
    public void getTreatmentFieldOverridesWithDOBReturnsCorrectJsonString() {
        ...
        patientDetails.put(BidanConstants.KEY.DOB, getDate(twentyOneYearsAgo));
    ...
    public void getTreatmentFieldOverridesWithIncorrectDOBReturnsCorrectJsonString() {
        ...
        patientDetails.put(BidanConstants.KEY.LAST_NAME, "Tell");
        patientDetails.put(BidanConstants.KEY.PROGRAM_ID, "7730");
        patientDetails.put(BidanConstants.KEY.DOB, "alpha");
