 ...
 */
public class KBClientsProviderTest extends BaseUnitTest {


    @Mock
    private KBClientsProvider kbClientsProvider;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        kbClientsProvider = new KBClientsProvider(RuntimeEnvironment.application, new View.OnClickListener() {
            @Override
    ...
    public void testInflater() {
        assertNotNull(kbClientsProvider.inflatelayoutForCursorAdapter());
    }
