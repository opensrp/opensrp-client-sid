 ...
 */
public class ANCClientsProviderTest extends BaseUnitTest {


    @Mock
    private ANCClientsProvider ancClientsProvider;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        ancClientsProvider = new ANCClientsProvider(RuntimeEnvironment.application, new View.OnClickListener() {
            @Override
    ...
    public void testInflater() {
        assertNotNull(ancClientsProvider.inflatelayoutForCursorAdapter());
    }
