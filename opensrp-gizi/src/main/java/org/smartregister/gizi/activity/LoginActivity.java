...
public class LoginActivity extends AppCompatActivity {
    ...
    private Context context = GiziApplication.getInstance().context();
    ...
    private void debugApp() {
        String uname = "demo_gizi3", pwd = "Demo@123";
...
//        getMenuInflater().inflate(R.menu.menu_main, menu);
    ...
    private void positionViews() {
        ...
        loginglogo.setImageDrawable(ResourcesCompat.getDrawable(getResources(), R.drawable.opensrp_indonesia_gizi_logo, null));
        ResourcesCompat.getDrawable(getResources(), R.drawable.opensrp_indonesia_gizi_logo, null);
...
/*        tryGetUniqueId(userName, password, new Listener<ResponseStatus>() {
    ...
    private void remoteLoginWith(String userName, String password, LoginResponseData userInfo) {
        ...
        Utils.writePreference(GiziApplication.getInstance().getApplicationContext(), PREF_TEAM_LOCATIONS, teamLocation.uuid);
