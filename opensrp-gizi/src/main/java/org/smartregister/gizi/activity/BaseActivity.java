...
public abstract class BaseActivity extends SecuredActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getAvailableLanguages().size() < MINIUM_LANG_COUNT) {
    ...
    public void showLanguageDialog() {
        ...
        final List<String> displayValues = org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getAvailableLanguages();
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, displayValues.toArray(new String[displayValues.size()])) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                view.setTextColor(org.smartregister.gizi.application.GiziApplication.getInstance().getContext().getColorResource(org.smartregister.gizi.R.color.customAppThemeBlue));
        ...
        builder.setSingleChoiceItems(adapter, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Map<String, String> langs = org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getAvailableLanguagesMap();
