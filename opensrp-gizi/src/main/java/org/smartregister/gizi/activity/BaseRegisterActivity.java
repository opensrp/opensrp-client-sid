...
import org.smartregister.gizi.event.ShowProgressDialogEvent;
import org.smartregister.gizi.event.SyncEvent;
import org.smartregister.gizi.fragment.BaseRegisterFragment;
...
public abstract class BaseRegisterActivity extends SecuredNativeSmartRegisterActivity implements DisplayFormListener {
    ...
    public static String TOOLBAR_TITLE = "org.smartregister.gizi.activity.toolbarTitle";
    ...
    protected List<String> buildFormNameList() {
        ...
        formNames.add(GiziConstants.ENKETO_FORMS.TREATMENT_INITIATION);
        formNames.add(Constants.FORM.CONTACT_SCREENING);
        formNames.add(GiziConstants.ENKETO_FORMS.FOLLOWUP_VISIT);
        formNames.add(GiziConstants.ENKETO_FORMS.ADD_TB_CONTACT);
        formNames.add(Constants.FORM.REMOVE_PATIENT);
        formNames.add(Constants.FORM.TREATMENT_OUTCOME);
        formNames.add(GiziConstants.ENKETO_FORMS.ADD_POSITIVE_PATIENT);
        return formNames;
    }
