package org.smartregister.gizi.adapter;
...
public class ServiceHistoryAdapter extends CursorAdapter implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        PopulateEnketoFormUtils enketoFormUtils = PopulateEnketoFormUtils.getInstance(mContext, org.smartregister.gizi.application.GiziApplication.getInstance().getEventClientRepository());
        String form;
        switch (formIdentifier) {
            ...
            case R.id.POSITIVE_TB_PATIENT:
                formSubmissionId = null;
                form = GiziConstants.ENKETO_FORMS.ADD_POSITIVE_PATIENT;
                break;
            default:
                return;
        }
