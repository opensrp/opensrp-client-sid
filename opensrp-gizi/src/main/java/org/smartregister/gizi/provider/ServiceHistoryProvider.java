...
import static org.smartregister.gizi.helper.view.RenderServiceHistoryCardHelper.UNION_FLAG_CONCAT_SEPARATOR;
...
public class ServiceHistoryProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] projection2, @Nullable String sortOrder) {
        ...
        return org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository().getReadableDatabase().rawQuery(sql, null);
