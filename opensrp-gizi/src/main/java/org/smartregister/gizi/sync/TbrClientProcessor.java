    ...
    private boolean processBMI(JSONObject event, JSONObject clientBMIJson) {
        ...
        try {
            ...
            if (contentValues != null && contentValues.size() > 0 && contentValues.getAsFloat(BMIRepository.WEIGHT) != null) {
                ...
                BMIRepository bmiRepository = org.smartregister.gizi.application.GiziApplication.getInstance().getBmiRepository();
    ...
    private boolean processResult(JSONObject event, JSONObject clientResultJson) {
        ...
        try {
            ...
            if (contentValues != null && contentValues.size() > 0 && contentValues.getAsString(ResultsRepository.RESULT1) != null) {
                ...
                ResultsRepository resultsRepository = org.smartregister.gizi.application.GiziApplication.getInstance().getResultsRepository();
                ...
                ResultDetailsRepository resultDetailsRepository = org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository();
