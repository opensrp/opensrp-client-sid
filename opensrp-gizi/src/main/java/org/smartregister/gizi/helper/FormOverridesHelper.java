...
public class FormOverridesHelper {
    ...
    public Map populateFieldOverrides() {
        ...
        fields.put(GiziConstants.KEY.PARTICIPANT_ID, patientDetails.get(GiziConstants.KEY.PARTICIPANT_ID));
        fields.put(GiziConstants.KEY.FIRST_NAME, patientDetails.get(GiziConstants.KEY.FIRST_NAME));
        fields.put(GiziConstants.KEY.LAST_NAME, patientDetails.get(GiziConstants.KEY.LAST_NAME));
        fields.put(GiziConstants.KEY.PROGRAM_ID, patientDetails.get(GiziConstants.KEY.PROGRAM_ID));
        return fields;
    }
    ...
    public FieldOverrides getFollowUpFieldOverrides() {
        Map fields = populateFieldOverrides();
        fields.put(GiziConstants.KEY.TREATMENT_INITIATION_DATE, patientDetails.get(GiziConstants.KEY.TREATMENT_INITIATION_DATE));
        JSONObject fieldOverridesJson = new JSONObject(fields);
        FieldOverrides fieldOverrides = new FieldOverrides(fieldOverridesJson.toString());
        return fieldOverrides;
    }
    ...
    public FieldOverrides getTreatmentFieldOverrides() {
        Map fields = populateFieldOverrides();
        String gender = patientDetails.get(GiziConstants.KEY.GENDER);
        if (gender != null) {
            fields.put(GiziConstants.KEY.GENDER, gender);
        }
        String dobString = patientDetails.get(GiziConstants.KEY.DOB);
        String age = "";
        ...
        fields.put(GiziConstants.KEY.AGE, age);
        JSONObject fieldOverridesJson = new JSONObject(fields);
        FieldOverrides fieldOverrides = new FieldOverrides(fieldOverridesJson.toString());
        return fieldOverrides;
    }
    ...
    public FieldOverrides getAddContactFieldOverrides() {
        Map fields = new HashMap();
        fields.put(GiziConstants.KEY.PARTICIPANT_ID, patientDetails.get(GiziConstants.KEY.PARTICIPANT_ID));
        fields.put(GiziConstants.KEY.PARENT_ENTITY_ID, patientDetails.get(Constants.KEY._ID));
        return new FieldOverrides(new JSONObject(fields).toString());
    }

    public FieldOverrides getContactScreeningFieldOverrides() {
        Map fields = populateFieldOverrides();
        fields.remove(GiziConstants.KEY.PARTICIPANT_ID);
        return new FieldOverrides(new JSONObject(fields).toString());
    }
}
