...
import org.smartregister.gizi.model.BMIRecord;
import org.smartregister.gizi.model.BMIRecordWrapper;
...
public class RenderBMIHeightChartCardHelper extends BaseRenderHelper {
    ...
    private BMIRecordWrapper getData(String baseEntityId) {
        return org.smartregister.gizi.application.GiziApplication.getInstance().getBmiRepository().getBMIRecords(baseEntityId);
    }
