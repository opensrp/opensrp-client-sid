...
import org.smartregister.gizi.adapter.ServiceHistoryAdapter;
...
import static org.smartregister.gizi.R.id.TB_REACH_ID;
...
public class RenderServiceHistoryCardHelper extends BaseRenderHelper implements
    ...
    private static final Uri CONTENT_URI = Uri.parse("content://com.smartregister.gizi.service.history.provider");
    ...
    public void renderView(final View view, final Map<String, String> metadata) {
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                if (listView != null) {
                    listView.setTag(TB_REACH_ID, metadata.get(Constants.KEY.GIZI_ID));
