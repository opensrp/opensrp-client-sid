...
import org.smartregister.gizi.model.Contact;
...
import static org.smartregister.gizi.util.Constants.ScreenStage;
import static util.GiziConstants.CONTACT_TABLE_NAME;
import static util.GiziConstants.KEY;
import static util.GiziConstants.PATIENT_TABLE_NAME;
...
public class RenderContactScreeningCardHelper extends BaseRenderHelper {
                            ...
                            public void onClick(View view) {
                                ...
                                if (contact != null) {
                                    if (contact.getStage().equals(ScreenStage.NOT_SCREENED)) {
                                        ...
                                        ((BasePatientDetailActivity) context).startFormActivity(GiziConstants.ENKETO_FORMS.CONTACT_SCREENING, contact.getBaseEntityId(), formOverridesHelper.getContactScreeningFieldOverrides().getJSONString());
                                    } else {
    ...
    private SQLiteDatabase getReadableDatabase() {
        return org.smartregister.gizi.application.GiziApplication.getInstance().getRepository().getReadableDatabase();
    }
    ...
    private Map getCommonPersonObjectDetails(String baseEntityId, String tableName) {
        ...
        try {
            ...
            if (cursor.moveToFirst())
                details = org.smartregister.gizi.application.GiziApplication.getInstance().getContext().commonrepository(tableName)
