...
public class OpenCameraActivity extends Activity implements PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GiziApplication.getInstance().refreshFaceData();
        initGuiAndAnimation();
        initExtras();
        initializeFlags();
        initListeners();
...
//        settingsActionListener();
    ...
    private void initExtras() {
        ...
        updated = extras.getBoolean("org.smartregister.gizi.facial.activity.OpenCameraActivity.updated");
        ...
        kidetail = extras.getParcelable("org.smartregister.gizi.facial.activity.OpenCameraActivity.kidetail");
...
//                }
    ...
    private void savePicture(byte[] data) {
        ...
        if (data != null) {
            intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity", data);
        }
        intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity.switchCamera", switchCamera);
        intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity.orientation", displayAngle);
        intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity.id", entityId);
        intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity.identify", identifyPerson);
        intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity.origin", str_origin_class);
        intent.putExtra("org.smartregister.gizi.facial.activity.PhotoConfirmationActivity.updated", updated);
