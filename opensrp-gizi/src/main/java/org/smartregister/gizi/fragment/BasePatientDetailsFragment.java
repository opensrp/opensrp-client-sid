...
import org.smartregister.gizi.activity.BasePatientDetailActivity;
import org.smartregister.gizi.activity.HomeActivity;
import org.smartregister.gizi.activity.InTreatmentPatientRegisterActivity;
import org.smartregister.gizi.activity.PositivePatientRegisterActivity;
import org.smartregister.gizi.event.EnketoFormSaveCompleteEvent;
import org.smartregister.gizi.event.SyncEvent;
import org.smartregister.gizi.helper.FormOverridesHelper;
import org.smartregister.gizi.helper.view.RenderBMIHeightChartCardHelper;
import org.smartregister.gizi.helper.view.RenderContactScreeningCardHelper;
import org.smartregister.gizi.helper.view.RenderPatientDemographicCardHelper;
import org.smartregister.gizi.helper.view.RenderPatientFollowupCardHelper;
import org.smartregister.gizi.helper.view.RenderPositiveResultsCardHelper;
import org.smartregister.gizi.helper.view.RenderServiceHistoryCardHelper;
import org.smartregister.gizi.model.Register;
...
import static org.smartregister.gizi.activity.BaseRegisterActivity.TOOLBAR_TITLE;
import static util.GiziConstants.ENKETO_FORMS;
...
public abstract class BasePatientDetailsFragment extends SecuredFragment implements View.OnClickListener {
    ...
    protected void renderPositiveResultsView(View view, Map<String, String> patientDetails) {
        RenderPositiveResultsCardHelper renderPositiveResultsHelper = new RenderPositiveResultsCardHelper(getActivity(), org.smartregister.gizi.application.GiziApplication.getInstance().getResultsRepository());
    ...
    protected void renderDemographicsView(View view, Map<String, String> patientDetails) {
        ...
        RenderPatientDemographicCardHelper renderPatientDemographicCardHelper = new RenderPatientDemographicCardHelper(getActivity(), org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository());
    ...
    protected void renderFollowUpView(View view, Map<String, String> patientDetails) {
        ...
        RenderPatientFollowupCardHelper renderPatientFollowupCardHelper = new RenderPatientFollowupCardHelper(getActivity(), org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository());
    ...
    protected void renderServiceHistoryView(View view, Map<String, String> patientDetails) {
        RenderServiceHistoryCardHelper renderServiceHistoryHelper = new RenderServiceHistoryCardHelper(getActivity(), org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository());
    ...
    protected void renderContactScreeningView(View view, Map<String, String> patientDetails) {
        RenderContactScreeningCardHelper renderContactScreeningHelper = new RenderContactScreeningCardHelper(getActivity(), org.smartregister.gizi.application.GiziApplication.getInstance().getResultsRepository());
    ...
    protected void renderBMIHeightChartView(View view, Map<String, String> patientDetails) {
        ...
        RenderBMIHeightChartCardHelper renderBMIHeightChartCardHelper = new RenderBMIHeightChartCardHelper(getActivity(), org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository());
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.add_contact:
                ((BasePatientDetailActivity) getActivity()).startFormActivity(ENKETO_FORMS.ADD_TB_CONTACT, patientDetails.get(GiziConstants.KEY.BASE_ENTITY_ID), formOverridesHelper.getAddContactFieldOverrides().getJSONString());
                break;
    ...
    protected void setupViews(View rootView) {
        ...
        ViewConfiguration config = org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getLanguage(Utils.getLanguage());
    ...
    protected void processViewConfigurations(View rootView) {
        try {
            String jsonString = org.smartregister.gizi.application.GiziApplication.getInstance().getConfigurableViewsRepository().getConfigurableViewJson(getViewConfigurationIdentifier());
            if (jsonString == null) {
                renderDefaultLayout(rootView);

            } else {
                ViewConfiguration detailsView = org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getConfigurableView(jsonString);
                ...
                if (!views.isEmpty()) {
                    ...
                    for (org.smartregister.configurableviews.model.View componentView : views) {
                        ...
                        try {
                            ...
                            String jsonComponentString = org.smartregister.gizi.application.GiziApplication.getInstance().getConfigurableViewsRepository().getConfigurableViewJson(componentView.getIdentifier());
                            ViewConfiguration componentViewConfiguration = org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getConfigurableView(jsonComponentString);
                            if (componentViewConfiguration != null) {

                                ConfigurableViewsHelper configurableViewsHelper = org.smartregister.gizi.application.GiziApplication.getInstance().getConfigurableViewsHelper();
                                ...
                                View json2View = org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().isEnableJsonViews() ? configurableViewsHelper.inflateDynamicView(componentViewConfiguration, viewParent, fallbackView, componentView.isVisible()) : fallbackView;
                                if (componentView.isVisible()) {
                                    json2View.setTag(R.id.VIEW_CONFIGURATION_ID, getViewConfigurationIdentifier());

                                    if (!org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().isEnableJsonViews()) {
