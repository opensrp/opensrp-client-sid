...
import org.smartregister.gizi.adapter.RegisterArrayAdapter;
import org.smartregister.gizi.model.Register;
import org.smartregister.gizi.model.RegisterCount;
...
public class HomeFragment extends ListFragment {
    ...
    public void onResume() {
        ...
        try {
            ...
            ViewConfiguration homeViewConfig = jsonString == null ? null : org.smartregister.gizi.application.GiziApplication.getJsonSpecHelper().getConfigurableView(jsonString);
    ...
    public static RegisterCount getPatientCountByRegisterType(String registerType) {
        ...
        return org.smartregister.gizi.application.GiziApplication.getInstance().getResultDetailsRepository().getRegisterCountByType(registerType);

    }

    private ConfigurableViewsRepository getConfigurableViewsRepository() {
        return org.smartregister.gizi.application.GiziApplication.getInstance().getConfigurableViewsRepository();
    }
