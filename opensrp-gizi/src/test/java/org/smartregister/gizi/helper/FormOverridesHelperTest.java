...
public class FormOverridesHelperTest {
    ...
    public void setUp() {
        ...
        patientDetails.put(GiziConstants.KEY.PARTICIPANT_ID, "5345");
        patientDetails.put(GiziConstants.KEY.FIRST_NAME, "William");
        patientDetails.put(GiziConstants.KEY.LAST_NAME, "Tell");
        patientDetails.put(GiziConstants.KEY.PROGRAM_ID, "7730");
        patientDetails.put(GiziConstants.KEY.TREATMENT_INITIATION_DATE, "2017-03-20");
    ...
    public void getFieldOverridesReturnsCorrectInstanceForSetDetails() {
        ...
        patientDetails.put(GiziConstants.KEY.PARTICIPANT_ID, "1099");
        patientDetails.put(GiziConstants.KEY.FIRST_NAME, "Speedy");
        patientDetails.put(GiziConstants.KEY.LAST_NAME, "Gonzalez");
        patientDetails.put(GiziConstants.KEY.PROGRAM_ID, "77555");
    ...
    public void getTreatmentFieldOverridesWithDOBReturnsCorrectJsonString() {
        ...
        patientDetails.put(GiziConstants.KEY.DOB, getDate(twentyOneYearsAgo));
    ...
    public void getTreatmentFieldOverridesWithIncorrectDOBReturnsCorrectJsonString() {
        ...
        patientDetails.put(GiziConstants.KEY.LAST_NAME, "Tell");
        patientDetails.put(GiziConstants.KEY.PROGRAM_ID, "7730");
        patientDetails.put(GiziConstants.KEY.DOB, "alpha");
