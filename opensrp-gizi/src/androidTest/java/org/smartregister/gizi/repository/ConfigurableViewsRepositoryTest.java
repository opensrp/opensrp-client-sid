...
public class ConfigurableViewsRepositoryTest {
    ...
    private GiziRepositoryShadow repositoryShadow = new GiziRepositoryShadow(GiziApplication.getInstance().getApplicationContext(), GiziApplication.getInstance().getContext());
